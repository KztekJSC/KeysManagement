    ...
    public class StaticList
    {
        ...
        public static List<SelectListModel_MenuGroup> GroupMenuList()
        {
            var list = new List<SelectListModel_MenuGroup> {
                                         new SelectListModel_MenuGroup { ItemValue = "12878956", ItemText = "Cấp key", ItemIndex = 3, ItemCode = "PK_", Icon = "/Content/Image/sy-parking-icon.png", Color = "infobox-blue", AreaName = "Admin", Layout = "~/Areas/Admin/Views/Shared/_Layout.cshtml", Label = "label-success"}
                                    };
